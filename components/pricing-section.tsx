      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-3 text-sm text-[#bca98d]">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <PricingModeCard icon={<Wand2 className="h-8 w-8 text-[#d7a957]" strokeWidth={1.5} />} title="x2 Enhance" credits={CREDIT_COSTS.ENHANCE_2X} copy="Light enhancement" />
            <PricingModeCard icon={<Sparkles className="h-8 w-8 text-[#d7a957]" strokeWidth={1.5} />} title="x3 Restore" credits={CREDIT_COSTS.ENHANCE_3X} copy="Balanced restoration" />
            <PricingModeCard icon={<Zap className="h-8 w-8 text-[#d7a957]" strokeWidth={1.5} fill="#d7a957" />} title="x4 Pro Restore" credits={CREDIT_COSTS.ENHANCE_4X} copy="Stronger AI enhancement" />
          </div>
        </div>
...
function PricingModeCard({
  ...
  return (
    <article className="rounded-2xl bg-white/[0.03] p-6 text-center shadow-[0_0_0_1px_rgba(255,255,255,0.04)]">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#17120f]">{icon}</div>
